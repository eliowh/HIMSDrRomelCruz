...
<body>
    <?php
        ...
        // Use values passed from route; fallback to 0
        $todayAdmissions = $todayAdmissionsCount ?? 0;
        $admittedPatients = $admittedPatients ?? ($patients->whereNotNull('room_no')->count() ?? 0);
        $pendingPatients = $pendingPatients ?? ($patients->whereNull('room_no')->count() ?? 0);
    ?>
