...
<body>
    ...
    <div class="pharmacy-layout">
        ...
        <main class="main-content">
            <?php $stockspharmacy = $stockspharmacy ?? collect(); $q = $q ?? ''; ?>
                    ...
                    <div class="pharmacy-card">
                        ...
                        <div class="pharmacy-search">
                            ...
                            <form method="GET" class="search-form">
                                <input type="search" name="q" value="<?php echo e($q); ?>" placeholder="Search stocks..." class="form-control" style="padding: 8px 12px; border: 1px solid #ddd; border-radius: 4px; margin-right: 8px;" />
                        ...
                        <?php if($stockspharmacy->count()): ?>
                            <div class="table-wrap">
                                <table class="orders-table" id="stocksTable" style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $stockspharmacy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="stock-row order-row" data-stock='<?php echo json_encode($s, 15, 512) ?>' style="transition: background-color 0.2s;">
                                            <td style="padding: 12px; text-align: left; border-bottom: 1px solid #eee;"><?php echo e($s->item_code); ?></td>
                                            <td style="padding: 12px; text-align: left; border-bottom: 1px solid #eee;"><?php echo e($s->generic_name); ?></td>
                                            <td style="padding: 12px; text-align: left; border-bottom: 1px solid #eee;"><?php echo e($s->brand_name); ?></td>
                                            <td style="padding: 12px; text-align: left; border-bottom: 1px solid #eee;">₱<?php echo e(is_numeric($s->price) ? number_format($s->price,2) : '0.00'); ?></td>
                                            <td style="padding: 12px; text-align: left; border-bottom: 1px solid #eee;"><?php echo e($s->quantity ?? 0); ?></td>
            ...
            <!-- Pagination -->
            <?php if($stockspharmacy->hasPages()): ?>
            <div class="pharmacy-pagination" style="margin-top: 20px;">
                <?php echo e($stockspharmacy->appends(['q' => $q])->links('components.custom-pagination')); ?>
...
</html><?php /**PATH D:\xampp\htdocs\DrRomelCruzHP\resources\views\pharmacy\pharmacy_stocks.blade.php ENDPATH**/ ?>