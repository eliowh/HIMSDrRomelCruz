...
<div style="padding: 20px;">
    <h2>Welcome, Dr. <?php echo e($doctorName); ?>!</h2>
    ...
    <div class="dashboard-stats">
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number"><?php echo e($todaysPatientsCount ?? 0); ?></p>
                <p class="stat-subtitle">Admissions for today</p>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number"><?php echo e($pendingReportsCount ?? 0); ?></p>
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number"><?php echo e($activePatients ?? 0); ?></p>
...
<?php echo $__env->make('layouts.doctor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\DrRomelCruzHP\resources\views\doctor\doctor_home.blade.php ENDPATH**/ ?>