...
<body>
        ...
        <div class="main-content">
            ...
            <div class="controls-row">
                <div class="filter-search-controls">
                    <input type="text" id="searchInput" placeholder="Search by room name or price..." class="search-input" value="<?php echo e(request('q')); ?>">
            ...
            <div class="admin-card">
                ...
                <table class="admin-table" id="roomsTable">
                    <thead>
                        <tr>
                            <th class="sortable" data-sort="COL 1">
                                Room Name
                                <?php if(request('sort') == 'COL 1' || !request('sort')): ?>
                                    <span class="sort-indicator <?php echo e(request('direction') == 'desc' ? 'desc' : 'asc'); ?>">
                                        <?php echo e(request('direction') == 'desc' ? '↓' : '↑'); ?>
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr id="<?php echo e($rowId); ?>" data-room-name="<?php echo e($roomName); ?>" data-price="<?php echo e($price); ?>">
                            <td><?php echo e($roomName); ?></td>
                            <td>₱<?php echo e(number_format($cleanPrice, 2)); ?></td>
                            <td>
                                <div class="action-dropdown">
                                    <button class="action-btn" onclick="toggleDropdown('<?php echo e($rowId); ?>')">
                                        <span>⋯</span>
                                    </button>
                                    <div class="dropdown-content" id="dropdown-<?php echo e($rowId); ?>">
                                        <a href="javascript:void(0);" onclick="editRoomByRow('<?php echo e($rowId); ?>')">Edit</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="pagination-wrapper">
                <?php if(isset($rooms) && method_exists($rooms, 'hasPages') && $rooms->hasPages()): ?>
                    <?php echo $__env->make('components.custom-pagination', ['paginator' => $rooms], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <?php echo $__env->make('admin.modals.admin_editRoom', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
</html><?php /**PATH D:\xampp\htdocs\DrRomelCruzHP\resources\views\admin\admin_rooms.blade.php ENDPATH**/ ?>