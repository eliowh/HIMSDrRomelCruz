    ...
    document.querySelectorAll('.delete-btn').forEach(function(btn){
        btn.addEventListener('click', function(){
            ...
            showConfirm('Are you sure you want to delete this stock item? This cannot be undone.', 'Confirm Deletion', function(confirmed) {
                ...
                fetch('<?php echo e(url('/inventory/stocks')); ?>/' + encodeURIComponent(id), {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': token,
...
</script><?php /**PATH D:\xampp\htdocs\DrRomelCruzHP\resources\views\Inventory\modals\inventory_scripts.blade.php ENDPATH**/ ?>