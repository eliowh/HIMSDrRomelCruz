...
<div class="sidebar" id="sidebar">
    ...
    <nav>
        <ul>
            <li>
                <a href="<?php echo e(asset('/pharmacy/home')); ?>"
                   class="sidebar-btn<?php echo e(request()->is('pharmacy/home') ? ' active' : ''); ?>">
                    <span class="icon">🏠</span> <span class="text">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(asset('/pharmacy/orders')); ?>"
                   class="sidebar-btn<?php echo e(request()->is('pharmacy/orders') ? ' active' : ''); ?>">
                    <span class="icon">💊</span> <span class="text">Orders</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(asset('/pharmacy/requests')); ?>"
                   class="sidebar-btn<?php echo e(request()->is('pharmacy/requests') ? ' active' : ''); ?>">
                    <span class="icon">🧾</span> <span class="text">Requests</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(asset('/pharmacy/stockspharmacy')); ?>"
                   class="sidebar-btn<?php echo e(request()->is('pharmacy/stockspharmacy') ? ' active' : ''); ?>">
...
<?php echo $__env->make('shared.logout_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\DrRomelCruzHP\resources\views\pharmacy\pharmacy_sidebar.blade.php ENDPATH**/ ?>