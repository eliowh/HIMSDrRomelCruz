                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h3><?php echo e($billings->total()); ?></h3>
                                </div>
                    ...
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h5>Paid Bills</h5>
                                    <h3><?php echo e($billings->where('status', 'paid')->count()); ?></h3>
                                </div>
                    ...
                    <div class="card bg-warning text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h5>Pending Bills</h5>
                                    <h3><?php echo e($billings->where('status', 'pending')->count()); ?></h3>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h3><?php echo e($billings->where('is_philhealth_member', true)->count()); ?></h3>
                                </div>
