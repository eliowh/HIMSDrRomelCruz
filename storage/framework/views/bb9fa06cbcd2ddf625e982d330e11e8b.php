...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/inventorycss/inventory_orders.css')); ?>">
...
<body>
    ...
    <div class="inventory-layout">
        ...
        <main class="main-content">
            <div class="inventory-card">
                <div class="card-header">
                    ...
                    <div class="status-tabs">
                        <a href="<?php echo e(route('inventory.orders', ['status' => 'all'])); ?>" 
                           class="status-tab <?php echo e($status === 'all' ? 'active' : ''); ?>">
                            All <span class="count">(<?php echo e($statusCounts['all']); ?>)</span>
                        </a>
                        <a href="<?php echo e(route('inventory.orders', ['status' => 'pending'])); ?>" 
                           class="status-tab <?php echo e($status === 'pending' ? 'active' : ''); ?>">
                            Pending <span class="count">(<?php echo e($statusCounts['pending']); ?>)</span>
                        </a>
                        <a href="<?php echo e(route('inventory.orders', ['status' => 'approved'])); ?>" 
                           class="status-tab <?php echo e($status === 'approved' ? 'active' : ''); ?>">
                            Approved <span class="count">(<?php echo e($statusCounts['approved']); ?>)</span>
                        </a>
                        <a href="<?php echo e(route('inventory.orders', ['status' => 'completed'])); ?>" 
                           class="status-tab <?php echo e($status === 'completed' ? 'active' : ''); ?>">
                            Completed <span class="count">(<?php echo e($statusCounts['completed']); ?>)</span>
                        </a>
                        <a href="<?php echo e(route('inventory.orders', ['status' => 'cancelled'])); ?>" 
                           class="status-tab <?php echo e($status === 'cancelled' ? 'active' : ''); ?>">
                            Cancelled <span class="count">(<?php echo e($statusCounts['cancelled']); ?>)</span>
                        </a>
                    </div>
                </div>
                            ...
                            <table class="orders-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($order->item_code); ?></td>
                                        <td><?php echo e($order->generic_name ?: '-'); ?></td>
                                        <td><?php echo e($order->brand_name ?: '-'); ?></td>
                                        ...
                                        <td>
                                            <div class="action-dropdown" id="action-dropdown-container-<?php echo e($order->id); ?>">
                                                <button class="action-btn" onclick="toggleDropdown(<?php echo e($order->id); ?>)">
                                                    <i class="fas fa-ellipsis-v"></i>
                                                </button>
                                                <div class="dropdown-content" id="dropdown-<?php echo e($order->id); ?>">
                                                    <a href="#" onclick="viewOrderDetails(<?php echo e($order->id); ?>)">
                                                        <i class="fas fa-eye"></i> View Details
                                                    </a>
                                                    <?php if($order->status === 'pending'): ?>
                                                        <a href="#" onclick="updateOrderStatus(<?php echo e($order->id); ?>, 'approved')" class="approve-action">
                                                            <i class="fas fa-check"></i> Approve
                                                        </a>
                                                        <a href="#" onclick="updateOrderStatus(<?php echo e($order->id); ?>, 'cancelled')" class="reject-action">
                                                            <i class="fas fa-times"></i> Reject
                                                        </a>
                                                    <?php elseif($order->status === 'approved'): ?>
                                                        <a href="#" onclick="openEncodeModal(<?php echo e($order->id); ?>, '<?php echo e($order->item_code); ?>', '<?php echo e($order->generic_name); ?>', '<?php echo e($order->brand_name); ?>', <?php echo e($order->quantity); ?>, <?php echo e($order->unit_price); ?>)" class="encode-action">
                                                            <i class="fas fa-edit"></i> Encode
                                                        </a>
                                                        <a href="#" onclick="updateOrderStatus(<?php echo e($order->id); ?>, 'completed')" class="complete-action">
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <h3>No <?php echo e($status !== 'all' ? $status : ''); ?> orders found</h3>
                        <p><?php echo e($status === 'all' ? 'There are no pharmacy orders at the moment.' : 'No orders with ' . $status . ' status found.'); ?></p>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="inventory-pagination">
                <?php echo e($orders->appends(['status' => $status])->links('components.custom-pagination')); ?>
    ...
    <?php echo $__env->make('Inventory.modals.encode_stock_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH D:\xampp\htdocs\DrRomelCruzHP\resources\views\Inventory\inventory_orders.blade.php ENDPATH**/ ?>