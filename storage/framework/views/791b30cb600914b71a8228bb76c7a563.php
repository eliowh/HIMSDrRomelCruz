        ...
        <tr>
            <td class="header-logo" rowspan="3">
                <?php if(file_exists($logoPath)): ?>
                    <img src="<?php echo e(asset('img/hospital_logo.png')); ?>" class="logo-img" />
                <?php else: ?>
        ...
        <table style="width:100%; border-collapse:collapse;">
            <tr class="sign-row">
                ...
                <td style="border:1px solid #000; width:20%; vertical-align:bottom; text-align:center; font-size:10px; padding-bottom:4px;">
                    ...
                    <div style="font-size:10px; font-weight:700; margin-top:4px;"><?php echo e(strtoupper($signature['designation'])); ?></div>
                </td>
            </tr>
        </table>
    </div>
</body>
</html><?php /**PATH D:\xampp\htdocs\DrRomelCruzHP\resources\views\labtech\templates\pdf\hematology.blade.php ENDPATH**/ ?>