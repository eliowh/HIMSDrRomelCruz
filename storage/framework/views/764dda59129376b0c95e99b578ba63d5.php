...
<div class="sidebar" id="sidebar">
    ...
    <nav>
        <ul>
            <li>
                <a href="/inventory/home" class="sidebar-btn<?php echo e(request()->is('inventory/home') ? ' active' : ''); ?>">
                    <span class="icon">🏠</span> <span class="text">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="/inventory/stocks" class="sidebar-btn<?php echo e(request()->is('inventory/stocks') ? ' active' : ''); ?>">
                    <span class="icon">📦</span> <span class="text">Stocks</span>
                </a>
            </li>
            <li>
                <a href="/inventory/orders" class="sidebar-btn<?php echo e(request()->is('inventory/orders') ? ' active' : ''); ?>">
                    <span class="icon">📝</span> <span class="text">Orders</span>
                </a>
            </li>
            <li>
                <a href="/inventory/reports" class="sidebar-btn<?php echo e(request()->is('inventory/reports') ? ' active' : ''); ?>">
...
<?php echo $__env->make('shared.logout_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\DrRomelCruzHP\resources\views\Inventory\inventory_sidebar.blade.php ENDPATH**/ ?>