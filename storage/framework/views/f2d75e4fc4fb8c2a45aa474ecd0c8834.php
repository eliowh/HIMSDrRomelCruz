            ...
            <div class="cashier-card">
                ...
                <div class="filter-controls">
                    ...
                    <div class="filter-buttons">
                        <button type="button" class="filter-btn <?php echo e(($stats['filter'] ?? 'week') === 'week' ? 'active' : ''); ?>" onclick="filterStatistics('week')">
                            <i class="fas fa-calendar-week"></i> Past Week
                        </button>
                        <button type="button" class="filter-btn <?php echo e(($stats['filter'] ?? 'week') === 'month' ? 'active' : ''); ?>" onclick="filterStatistics('month')">
                            <i class="fas fa-calendar-alt"></i> Past Month
                        </button>
                        <button type="button" class="filter-btn <?php echo e(($stats['filter'] ?? 'week') === 'year' ? 'active' : ''); ?>" onclick="filterStatistics('year')">
