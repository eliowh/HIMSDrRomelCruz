    ...
    <div class="admin-layout">
        ...
        <div class="main-content">
            ...
            <div class="controls-row">
                <div class="filter-search-controls">
                    <select id="roleFilter" class="role-select">
                        ...
                        <option value="inventory" <?php echo e(request('role') == 'inventory' ? 'selected' : ''); ?>>Inventory</option>
                        <option value="cashier" <?php echo e(request('role') == 'cashier' ? 'selected' : ''); ?>>Cashier</option>
                        <option value="pharmacy" <?php echo e(request('role') == 'pharmacy' ? 'selected' : ''); ?>>Pharmacy</option>
                        <option value="billing" <?php echo e(request('role') == 'billing' ? 'selected' : ''); ?>>Billing</option>
                    </select>
                    <input type="text" id="searchInput" placeholder="Search by name..." class="search-input" value="<?php echo e(request('search')); ?>">
            ...
            <div class="admin-card">
                ...
                <table class="admin-table" id="usersTable">
                    ...
                    <tbody>
                        ...
                        <tr data-role="<?php echo e($user->role); ?>" data-name="<?php echo e(strtolower($user->name)); ?>">
                            <td><?php echo e($user->name); ?></td>
                            <td><?php echo e($user->email); ?></td>
                            <td>
                                <span class="role-badge role-<?php echo e($user->role); ?>">
                                    <?php if($user->role === 'lab_technician'): ?>
                                        Lab Technician
                                    <?php else: ?>
                            ...
                            <td><?php echo e($user->created_at ? $user->created_at->format('M d, Y') : 'N/A'); ?></td>
                            <td>
                                <div class="action-dropdown">
                                    <button class="action-btn" onclick="toggleDropdown(<?php echo e($user->id); ?>)">
                                        <span>⋯</span>
                                    </button>
                                    <div class="dropdown-content" id="dropdown-<?php echo e($user->id); ?>">
                                        <a href="#" onclick="editUser(<?php echo e($user->id); ?>)">Edit</a>
                                        <a href="#" onclick="deleteUser(<?php echo e($user->id); ?>)" class="delete-action">Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="pagination-wrapper">
                <?php echo $__env->make('components.custom-pagination', ['paginator' => $users], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </div>

    <?php echo $__env->make('admin.modals.admin_createUser', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('admin.modals.admin_editUser', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
</html><?php /**PATH D:\xampp\htdocs\DrRomelCruzHP\resources\views\admin\admin_users.blade.php ENDPATH**/ ?>