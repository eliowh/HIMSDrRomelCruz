...
<div class="sidebar" id="sidebar">
    ...
    <nav>
        <ul>
            <li>
                <a href="<?php echo e(asset('/cashier/home')); ?>"
                   class="sidebar-btn<?php echo e(request()->is('cashier/home') ? ' active' : ''); ?>">
                    <span class="icon">🏠</span> <span class="text">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(asset('/cashier/billing')); ?>"
                   class="sidebar-btn<?php echo e(request()->is('cashier/billing') ? ' active' : ''); ?>">
...
<?php /**PATH D:\xampp\htdocs\DrRomelCruzHP\resources\views\cashier\cashier_sidebar.blade.php ENDPATH**/ ?>