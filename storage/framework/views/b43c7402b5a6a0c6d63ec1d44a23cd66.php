...
<link rel="stylesheet" href="<?php echo e(asset('css/nursecss/nurse_addPatients_fixes.css')); ?>">
    ...
    <?php if(session('success')): ?>
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                nurseSuccess('Patient Added', '<?php echo e(session('success')); ?>');
            });
        </script>
    <?php endif; ?>
    ...
    <form action="/nurse/addPatients" method="POST">
        ...
        <div class="two-column-form">
            <div class="form-group">
                ...
                <input id="first_name" type="text" name="first_name" placeholder="Enter first name" required value="<?php echo e(old('first_name')); ?>">
            </div>

            <div class="form-group">
                <label for="last_name">Last Name</label>
                <input id="last_name" type="text" name="last_name" placeholder="Enter last name" required value="<?php echo e(old('last_name')); ?>">
            </div>

            <div class="form-group">
                <label for="middle_name">Middle Name</label>
                <input id="middle_name" type="text" name="middle_name" placeholder="Enter middle name" value="<?php echo e(old('middle_name')); ?>">
            </div>

            <div class="form-group">
                <label for="date_of_birth">Date of Birth</label>
                <input id="date_of_birth" type="date" name="date_of_birth" required value="<?php echo e(old('date_of_birth')); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input id="contact_number" type="number" name="contact_number" placeholder="Enter contact number" min="1000000000" max="99999999999" maxlength="11" oninput="if(this.value.length > 11) this.value = this.value.slice(0, 11);" value="<?php echo e(old('contact_number')); ?>">
            </div>

            <div class="form-group">
                <label for="province">Province</label>
                <input id="province" type="text" name="province" placeholder="Enter province" value="<?php echo e(old('province')); ?>">
            </div>

            <div class="form-group">
                <label for="city">City</label>
                <input id="city" type="text" name="city" placeholder="Enter city" value="<?php echo e(old('city')); ?>">
            </div>

            <div class="form-group">
                <label for="barangay">Barangay</label>
                <input id="barangay" type="text" name="barangay" placeholder="Enter barangay" required value="<?php echo e(old('barangay')); ?>">
            </div>

            <div class="form-group">
                <label for="nationality">Nationality</label>
                <input id="nationality" type="text" name="nationality" placeholder="Enter nationality" required value="<?php echo e(old('nationality','Filipino')); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-validation-container">
                    <div class="suggestion-container">
                        <input id="room-input" type="text" name="room_no" autocomplete="off" value="<?php echo e(old('room_no')); ?>" placeholder="Type room name or price">
            ...
            <div class="form-group">
                ...
                <div class="input-validation-container">
                    <div class="suggestion-container">
                        <input id="admission-diagnosis" name="admission_diagnosis" type="text" autocomplete="off" placeholder="Type ICD-10 code or disease name" value="<?php echo e(old('admission_diagnosis')); ?>">
            ...
            <div class="form-group full-width">
                ...
                <input id="admission-diagnosis-desc" name="admission_diagnosis_description" type="text" placeholder="Description will appear here" readonly value="<?php echo e(old('admission_diagnosis_description')); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <div style="display:flex;gap:8px;align-items:center;">
                    <div class="input-validation-container" style="flex:1;">
                        <div class="suggestion-container">
                            <input id="doctor_name" name="doctor_name" type="text" autocomplete="off" placeholder="Type doctor name or select" value="<?php echo e(old('doctor_name')); ?>" style="flex:1;">
            ...
            <div class="form-group">
                ...
                <select id="doctor_type" name="doctor_type" required>
                    <option value="" disabled <?php echo e(old('doctor_type')=='' ? 'selected':''); ?>>-- Select --</option>
                    <option value="PHYSICIAN" <?php echo e(old('doctor_type')=='PHYSICIAN' ? 'selected':''); ?>>PHYSICIAN</option>
                    <option value="SURGEON / ROD" <?php echo e(old('doctor_type')=='SURGEON / ROD' ? 'selected':''); ?>>SURGEON / ROD</option>
                    <option value="PHYSICIAN / ROD" <?php echo e(old('doctor_type')=='PHYSICIAN / ROD' ? 'selected':''); ?>>PHYSICIAN / ROD</option>
                    <option value="ANESTHESIOLOGIST" <?php echo e(old('doctor_type')=='ANESTHESIOLOGIST' ? 'selected':''); ?>>ANESTHESIOLOGIST</option>
                    <option value="GASTROENTEROLOGIST" <?php echo e(old('doctor_type')=='GASTROENTEROLOGIST' ? 'selected':''); ?>>GASTROENTEROLOGIST</option>
                    <option value="NEUROLOGIST" <?php echo e(old('doctor_type')=='NEUROLOGIST' ? 'selected':''); ?>>NEUROLOGIST</option>
                    <option value="ONCOLOGIST" <?php echo e(old('doctor_type')=='ONCOLOGIST' ? 'selected':''); ?>>ONCOLOGIST</option>
                    <option value="OPHTHALMOLOGIST" <?php echo e(old('doctor_type')=='OPHTHALMOLOGIST' ? 'selected':''); ?>>OPHTHALMOLOGIST</option>
                    <option value="ORTHOPAEDIC" <?php echo e(old('doctor_type')=='ORTHOPAEDIC' ? 'selected':''); ?>>ORTHOPAEDIC</option>
                    <option value="OB-GYN / SURGEON" <?php echo e(old('doctor_type')=='OB-GYN / SURGEON' ? 'selected':''); ?>>OB-GYN / SURGEON</option>
                    <option value="PEDIATRICIAN" <?php echo e(old('doctor_type')=='PEDIATRICIAN' ? 'selected':''); ?>>PEDIATRICIAN</option>
                    <option value="INFECTIOUS MED." <?php echo e(old('doctor_type')=='INFECTIOUS MED.' ? 'selected':''); ?>>INFECTIOUS MED.</option>
                    <option value="UROLOGIST" <?php echo e(old('doctor_type')=='UROLOGIST' ? 'selected':''); ?>>UROLOGIST</option>
                    <option value="ENT" <?php echo e(old('doctor_type')=='ENT' ? 'selected':''); ?>>ENT</option>
                    <option value="NEPHROLOGIST" <?php echo e(old('doctor_type')=='NEPHROLOGIST' ? 'selected':''); ?>>NEPHROLOGIST</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="admission_type" name="admission_type" required>
                    <option value="" disabled <?php echo e(old('admission_type')=='' ? 'selected':''); ?>>-- Select Service --</option>
                    <option value="Inpatient" <?php echo e(old('admission_type')=='Inpatient' ? 'selected':''); ?>>Inpatient</option>
                    <option value="Outpatient" <?php echo e(old('admission_type')=='Outpatient' ? 'selected':''); ?>>Outpatient</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xamppLatest\htdocs\HIMSDrRomelCruz\resources\views/nurse/nurse_addPatients.blade.php ENDPATH**/ ?>