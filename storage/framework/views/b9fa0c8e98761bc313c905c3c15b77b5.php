        ...
        <form id="labRequestForm">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="scheduledDate" name="scheduled_date" min="<?php echo e(date('Y-m-d')); ?>">
                </div>
            </div>
...
</style><?php /**PATH D:\xamppLatest\htdocs\HIMSDrRomelCruz\resources\views/nurse/modals/lab_request_modal.blade.php ENDPATH**/ ?>