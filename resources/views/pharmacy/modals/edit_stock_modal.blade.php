    ...
    fetch('/pharmacy/stocks/' + encodeURIComponent(id), {
        ...
        if (ct.includes('application/json')) {
            ...
            if (!updated) {
                ...
                // try to preserve selection then reload so UI reflects server state
                try{ sessionStorage.setItem('pharmacy_selected_item', j.stock.item_code || j.stock.id); }catch(e){}
