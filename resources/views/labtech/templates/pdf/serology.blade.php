...
<head>
    ...
    <style>
        ...
        table.results td.label { width:250px; }
...
<body>
    <table class="header-table">
        ...
        <tr>
            <td class="form-title">SEROLOGY LABORATORY RESULT FORM</td>
        </tr>
        <tr>
            <td style="padding:0;">
    ...
    <table class="results">
        <thead>
            <tr>
                <th style="width:250px;">TEST / EXAMINATION</th>
                <th class="value-col">RESULT</th>
            </tr>
        </thead>
        <tbody>
