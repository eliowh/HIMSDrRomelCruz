    ...
    <div class="form-sections">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="patient_no" name="patient_no" value="{{ $patient->patient_no ?? '' }}" readonly class="form-input readonly">
                </div>
                <div class="form-group">
                    <label for="first_name">First Name</label>
                    <input type="text" id="first_name" name="first_name" value="{{ $patient->first_name ?? '' }}" class="form-input" readonly>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="middle_name" name="middle_name" value="{{ $patient->middle_name ?? '' }}" class="form-input" readonly>
                </div>
                <div class="form-group">
                    <label for="last_name">Last Name</label>
                    <input type="text" id="last_name" name="last_name" value="{{ $patient->last_name ?? '' }}" class="form-input" readonly>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="date" id="date_of_birth" name="date_of_birth" value="{{ $patient->date_of_birth ?? '' }}" class="form-input" readonly>
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select id="marital_status" name="marital_status" class="form-input" disabled>
                        ...
                        <option value="single" {{ strtolower($patient->marital_status ?? '') == 'single' ? 'selected' : '' }}>Single</option>
                        <option value="married" {{ strtolower($patient->marital_status ?? '') == 'married' ? 'selected' : '' }}>Married</option>
                        <option value="divorced" {{ strtolower($patient->marital_status ?? '') == 'divorced' ? 'selected' : '' }}>Divorced</option>
                        <option value="widowed" {{ strtolower($patient->marital_status ?? '') == 'widowed' ? 'selected' : '' }}>Widowed</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" value="{{ $patient->email ?? '' }}" class="form-input" readonly>
                </div>
            </div>
            
            <div class="form-group">
                <label for="address">Address</label>
                <textarea id="address" name="address" class="form-input" rows="3" readonly>{{ $patient->address ?? '' }}</textarea>
            </div>
            
            <div class="form-row">
                <div class="form-group">
                    <label for="emergency_contact_name">Emergency Contact Name</label>
                    <input type="text" id="emergency_contact_name" name="emergency_contact_name" value="{{ $patient->emergency_contact_name ?? '' }}" class="form-input" readonly>
                </div>
                <div class="form-group">
                    <label for="emergency_contact_phone">Emergency Contact Phone</label>
                    <input type="tel" id="emergency_contact_phone" name="emergency_contact_phone" value="{{ $patient->emergency_contact_phone ?? '' }}" class="form-input" readonly>
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select id="patient_status" name="status" class="form-input" disabled>
                        <option value="active" {{ strtolower($patient->status ?? 'active') == 'active' ? 'selected' : '' }}>Active</option>
                        <option value="discharged" {{ strtolower($patient->status ?? '') == 'discharged' ? 'selected' : '' }}>Discharged</option>
                        <option value="deceased" {{ strtolower($patient->status ?? '') == 'deceased' ? 'selected' : '' }}>Deceased</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="allergies" name="allergies" class="form-input" rows="2" readonly>{{ $patient->allergies ?? '' }}</textarea>
            </div>
            
            <div class="form-group">
                <label for="medical_history">Medical History</label>
                <textarea id="medical_history" name="medical_history" class="form-input" rows="3" readonly>{{ $patient->medical_history ?? '' }}</textarea>
            </div>
            
            <div class="form-group">
                <label for="current_medications">Current Medications</label>
                <textarea id="current_medications" name="current_medications" class="form-input" rows="3" readonly>{{ $patient->current_medications ?? '' }}</textarea>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="room_no" name="room_no" value="{{ $patient->room_no ?? '' }}" class="form-input" readonly>
                </div>
                <div class="form-group">
                    <label for="admission_date">Admission Date</label>
                    <input type="datetime-local" id="admission_date" name="admission_date" 
                           value="{{ $patient->admission_date ? date('Y-m-d\TH:i', strtotime($patient->admission_date)) : '' }}" 
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="datetime-local" id="discharge_date" name="discharge_date" 
                           value="{{ $patient->discharge_date ? date('Y-m-d\TH:i', strtotime($patient->discharge_date)) : '' }}" 
                           class="form-input" readonly>
                </div>
                <div class="form-group">
                    <label for="admitting_doctor">Admitting Doctor</label>
                    <input type="text" id="admitting_doctor" name="admitting_doctor" value="{{ $patient->admitting_doctor ?? '' }}" class="form-input" readonly>
                </div>
            </div>
            
            <div class="form-group">
                <label for="diagnosis">Diagnosis</label>
                <textarea id="diagnosis" name="diagnosis" class="form-input" rows="3" readonly>{{ $patient->diagnosis ?? '' }}</textarea>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <textarea id="notes" name="notes" class="form-input" rows="4" readonly>{{ $patient->notes ?? '' }}</textarea>
            </div>
        </div>
    </div>
