...
<div id="medicineHistoryModal" class="modal">
    <div class="modal-content medicine-history-modal-content">
        ...
        <div class="modal-footer">
            <button class="btn btn-primary" onclick="printMedicineHistory()" id="printMedicineHistoryBtn" style="display:none;">
...
function showMedicineHistoryLoading() {
    ...
    document.getElementById('printMedicineHistoryBtn').style.display = 'none';
}
...
function displayMedicineHistory(medicines) {
    ...
    document.getElementById('printMedicineHistoryBtn').style.display = 'inline-block';
}
